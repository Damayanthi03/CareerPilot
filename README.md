...
- Explore recommended career domains
...
- AI Resume Analyzer with Skill Gap Detection
- AI Mock Interview & Feedback System
- Google/GitHub Social Authentication
- Personalized Career Learning Roadmaps
- Real-Time Skill Progress Tracking Dashboard
